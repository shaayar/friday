...
class MemoryProvenance:
    ...
    def __post_init__(self) -> None:
        ...
        normalized_message_ids = tuple(str(message_id).strip() for message_id in self.source_message_ids)
...
class Memory:
    ...
    def __post_init__(self) -> None:
        ...
        valid_from = created_at if self.valid_from is None else _require_aware_timestamp("valid_from", self.valid_from)
        valid_until = None if self.valid_until is None else _require_aware_timestamp("valid_until", self.valid_until)

...
class TestPromotionDependencyConstruction:
    ...
    @pytest.mark.asyncio
    async def test_promotion_store_uses_conversations_db(self, temp_friday_home) -> None:
    ...
    @pytest.mark.asyncio
    async def test_promoter_receives_existing_memory_manager(self, temp_friday_home) -> None:
    ...
    @pytest.mark.asyncio
    async def test_memory_extraction_construction_unchanged(self, temp_friday_home) -> None:
